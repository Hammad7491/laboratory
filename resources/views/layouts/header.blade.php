...
<style>
  ...
  html,body{max-width:100%;overflow-x:hidden} /* safety: no side scroll */
  ...
  .eg-link:hover{color:#1d2251;background:linear-gradient(180deg,#eef7ff,#f4efff);box-shadow:0 6px 16px rgba(6,182,212,.12)}
  .eg-cta{background:linear-gradient(135deg,#06b6d4,#7c3aed);color:#fff!important;border:1px solid rgba(255,255,255,.45);box-shadow:0 10px 22px rgba(124,58,237,.28)}
  .eg-cta:hover{filter:saturate(110%);transform:translateY(-1px);box-shadow:0 12px 26px rgba(124,58,237,.34)}

  /* Mega dropdown — centered and clamped so it never overflows */
  ...
  .eg-has-mega .eg-mega{
    position:absolute;
    left:50%;                               /* center under “Services” */
    top:calc(100% + 8px);
    transform:translate(-50%,8px) scale(.98);
    background:#fff;border:1px solid rgba(15,23,42,.06);
    border-radius:18px;box-shadow:0 22px 46px rgba(15,23,42,.12);
    padding:18px;
    width:clamp(560px, 70vw, 980px);        /* responsive width */
    max-width:calc(100vw - 32px);           /* never exceed viewport */
    display:grid;grid-template-columns:1fr 1fr;gap:28px;
    opacity:0;pointer-events:none;transition:opacity .15s, transform .15s;will-change:transform,opacity;
  }
  ...
  .eg-mega-title{font-size:13px;letter-spacing:.5px;color:#f59e0b;font-weight:500}
  .eg-mega-list{list-style:none;margin:0;padding:0;display:grid;gap:10px}
  .eg-mega-list a{text-decoration:none;color:#1a2644;font-weight:400;font-size:16px;padding:6px 8px;border-radius:10px;border:1px solid transparent;overflow-wrap:anywhere}
  .eg-mega-list a:hover{background:#f7fbff;border-color:#eaf3ff;color:#0f1f3a}
  ...
  .eg-mobile a:hover{background:#f6fbff}
  .eg-m-cta{background:#7c3aed!important;color:#fff!important;border-color:transparent!important;box-shadow:0 10px 22px rgba(124,58,237,.25)}
  ...
  .eg-m-mega{display:none;gap:10px;margin-top:8px;border-left:3px solid #e6f5ff;padding:8px 10px}
  .eg-m-mega-col{display:flex;flex-direction:column;gap:6px}
  .eg-m-mega-title{font-size:12px;color:#f59e0b}
