...
<section class="svc-phleb" style="padding-top:18px; font-family:'Poppins',sans-serif;">
    ...
    <div class="svc-hero-text" style="position:absolute; inset:0; display:grid; place-items:center; text-align:center; color:#fff; padding:24px;">
      <div>
        ...
        <p style="max-width:760px; margin:12px auto 0; font:400 clamp(14px,2vw,17px)/1.6 Poppins, sans-serif; opacity:.95;">
          Professional, reliable blood draws—delivered where you are. Skip the waiting room and let our certified team come to your
          home, office, or care facility with hospital-grade standards.
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="svc-intro" style="display:grid; grid-template-columns:1.2fr .8fr; gap:28px; align-items:start;">
      <div>
        ...
        <p style="font:400 16px/1.8 Poppins, sans-serif; color:#24324a; margin:0 0 12px;">
          ...
          clean, comfortable, and efficient draw.
        </p>
        <p style="font:400 16px/1.8 Poppins, sans-serif; color:#24324a; margin:0 0 12px;">
          Every visit follows strict safety and labeling protocols. Results are routed to your preferred laboratory or provider,
          including Quest Diagnostics, LabCorp, and other partnered labs. Whether it’s a standing order or a one-time test,
          EmmaGenix keeps the process simple and transparent.
        </p>
      ...
      <aside class="svc-side" style="background:#fff; border:1px solid rgba(2,6,23,.06); border-radius:14px; padding:18px; box-shadow:0 10px 24px rgba(2,6,23,.06);">
        ...
        <ol style="margin:0; padding-left:18px; font:400 14.5px/1.8 Poppins, sans-serif; color:#23304a;">
          ...
          <li>Quick identity &amp; order verification; gentle blood draw.</li>
          <li>Samples are labeled, stored, and delivered to your lab.</li>
          <li>Results go to your provider / portal per your lab’s policy.</li>
        </ol>
        <a href="#book" style="
  ...
  <div class="svc-gallery" style="max-width:1100px; margin:26px auto 6px; padding:0 16px;">
    <div style="display:grid; gap:14px; grid-template-columns:1fr 1fr 1fr;">
      ...
      <figure style="margin:0; border-radius:14px; overflow:hidden; border:1px solid rgba(2,6,23,.06); box-shadow:0 8px 18px rgba(2,6,23,.06);">
        <img src="{{ asset('assets/images/p4.png') }}" alt="Kid-friendly phlebotomy" style="width:100%; height:220px; object-fit:cover;">
        <figcaption style="padding:10px 12px; font:400 14px/1.6 Poppins, sans-serif; color:#334155;">Pediatric to senior-care: gentle, patient-first approach.</figcaption>
      </figure>
    </div>
  </div>
  ...
  <div class="svc-faq" style="max-width:980px; margin:20px auto 0; padding:0 16px;">
    <details style="background:#fff;border:1px solid rgba(2,6,23,.08);border-radius:12px;padding:14px 16px;margin-bottom:10px;">
      ...
      <div style="font:400 14.5px/1.75 Poppins, sans-serif; color:#334155; padding-top:8px;">
        For most diagnostic tests, yes—bring a valid order from your provider. Wellness screenings may be available without an order depending on your location.
      </div>
    </details>
    <details style="background:#fff;border:1px solid rgba(2,6,23,.08);border-radius:12px;padding:14px 16px;margin-bottom:10px;">
      <summary style="cursor:pointer; font:500 15px/1.5 Poppins, sans-serif; color:#0f1f3a;">Which labs do you support?</summary>
      <div style="font:400 14.5px/1.75 Poppins, sans-serif; color:#334155; padding-top:8px;">
        We collect for Quest Diagnostics, LabCorp, and many regional labs. If your lab requires a special kit, we’ll use it and handle the courier drop-off.
      </div>
    </details>
    <details style="background:#fff;border:1px solid rgba(2,6,23,.08);border-radius:12px;padding:14px 16px;">
      <summary style="cursor:pointer; font:500 15px/1.5 Poppins, sans-serif; color:#0f1f3a;">How should I prepare?</summary>
      <div style="font:400 14.5px/1.75 Poppins, sans-serif; color:#334155; padding-top:8px;">
        Follow your provider’s instructions (e.g., fasting). Stay hydrated, have your ID and lab order ready, and choose a comfortable, well-lit space for the visit.
      </div>
    </details>
  </div>
